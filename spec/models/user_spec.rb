...
describe User do
  ...
  let(:external_user_valid_attributes) { { name: "Usuario Externo", matricula: "25391659310", username: "externo",
                                           password: "13123", external_user: true } }
  let(:external_user_invalid_cpf) { { name: "Usuario Externo", matricula: "123", username: "externo",
                                      password: "13123", external_user: true } }
